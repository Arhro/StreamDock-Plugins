...
const Plugin = {
  ...
  i18n: {
    en: {
      Name: 'Home Assistant',
      Description: 'Display images and sensors from Home Assistant'
    },
    zh_CN: {
      Name: 'Home Assistant',
      Description: '显示来自Home Assistant的图像和传感器'
    }
  }
};
...
const Actions = [
  {
    ...
    i18n: {
      en: {
        Name: 'Camera Image',
        Tooltip: 'Display camera image from Home Assistant'
      },
      zh_CN: {
        Name: '摄像头图像',
        Tooltip: '显示来自Home Assistant的摄像头图像'
      }
    },
    state: 0,
    States: [
